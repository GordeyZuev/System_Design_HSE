...
class Settings(BaseSettings):
    ...
    '''
    OFFER_SERVICE_URL: str = "http://offer-service:8002"
    STATIONS_SERVICE_URL: str = "http://stations-adapter:8005"
    PAYMENTS_SERVICE_URL: str = "http://payments-adapter:8006"
    ...
    DB_URL: Optional[str] = "postgresql+asyncpg://postgres:password@rental-cmd-db:5432/rental_cmd_test"

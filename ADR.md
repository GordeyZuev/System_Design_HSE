...
- Write: **1000 RPS** (создание/завершение аренд)
- Read: **100,000 RPS** (просмотр статуса, Y=100 просмотров на аренду)
...
**Облако (Yandex Cloud):**
- PostgreSQL: 16 * m3-c16-m128 (₽60K/мес) = **₽960K/мес** (~$10K)
- App: 10 * c3-c8-m16 (₽15K/мес) = **₽150K/мес** (~$1.5K)
- Storage: 10.5TB SSD (₽10K/TB/мес) = **₽105K/мес** (~$1K)
- **Итого: ~₽1.2M/месяц ($12-13K/месяц)**

**MVP (100K users, 2 шарда):**
- Storage: ~1 TB, RAM: ~300 GB, CPU: ~50 cores
- **Стоимость: ₽200-250K/месяц (~$2-3K)**
